                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div className="p-6 text-black-900">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="custom-file flex justify-center border border-blue-500 hover:border-transparent">
                                    <input
                                        type="file"
                                        name="file"
                                    ...
                                    />
                                    <label className="custom-file-label bg-teal hover:bg-[1D7874] text-white font-bold  rounded" htmlFor="chooseFile">
